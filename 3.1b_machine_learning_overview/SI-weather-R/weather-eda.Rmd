...
```{r}
# Look at dataframe structure to determine categorical variables:  Location, WindGustDir, WindDir9am, WindDir3pm, RainToday, RainTomorrow
str(df)
```
...
cor(df.num, use = "pairwise")
ggcorr(df.num, label=TRUE, 
       label_round=2, 
       label_size=3, size=2.5)  # ggcorr uses cor to calculate correlations
```
